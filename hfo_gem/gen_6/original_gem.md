# Hive Fleet Obsidian — Gem 1 (Generation 6: Pass 6 Refinement)
...
| Ritual Generator | Heading order lint, template checksum, MT-count reset | On render + hourly | Evaluator logs failure; Overmind ping if unresolved |
